              ...
              >
                ...
                >
                  <Dialog.Title
                    ...
                    className={classNames(
                      titleClassName,
                      "flex items-center justify-between text-lg font-medium leading-6 text-gray-900 border-b p-6"
                    )}
                  >
                    <div className="flex items-center justify-start gap-x-2 mr-2 capitalize">
                      {icon && icon}
                      <h3>{title}</h3>
                    </div>
                    <Button
